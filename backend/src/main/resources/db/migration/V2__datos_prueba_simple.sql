...
-- ============================================================================
-- Este script usa IDs explícitos para mayor control
...
-- ALTER SEQUENCE seq_tickets RESTART START WITH 1;
-- ALTER SEQUENCE seq_cambios_estado RESTART START WITH 1;
...
-- Hardware EN_PROGRESO (4)
INSERT INTO tickets (ticket_id, titulo, descripcion, solicitante, categoria, prioridad, estado, fecha_creacion, fecha_actualizacion)
VALUES (9, 'HW009 - Disco duro lleno', 'El disco está al 95% capacidad', 'Miguel Ángel', 'Hardware', 'ALTA', 'EN_PROGRESO', SYSDATE, SYSDATE);

INSERT INTO tickets (ticket_id, titulo, descripcion, solicitante, categoria, prioridad, estado, fecha_creacion, fecha_actualizacion)
VALUES (10, 'HW010 - Memoria RAM insuficiente', 'El equipo se congela constantemente', 'Carmen Flores', 'Hardware', 'ALTA', 'EN_PROGRESO', SYSDATE, SYSDATE);

INSERT INTO tickets (ticket_id, titulo, descripcion, solicitante, categoria, prioridad, estado, fecha_creacion, fecha_actualizacion)
VALUES (11, 'HW011 - Puerto USB dañado', 'El puerto USB no reconoce dispositivos', 'Diego Hernández', 'Hardware', 'MEDIA', 'EN_PROGRESO', SYSDATE, SYSDATE);

INSERT INTO tickets (ticket_id, titulo, descripcion, solicitante, categoria, prioridad, estado, fecha_creacion, fecha_actualizacion)
VALUES (12, 'HW012 - Ventilador ruidoso', 'El ventilador del CPU hace ruido', 'Patricia Vega', 'Hardware', 'BAJA', 'EN_PROGRESO', SYSDATE, SYSDATE);
...
-- Software EN_PROGRESO (3)
INSERT INTO tickets (ticket_id, titulo, descripcion, solicitante, categoria, prioridad, estado, fecha_creacion, fecha_actualizacion)
VALUES (21, 'SW006 - Instalación SAP', 'Requiere instalación SAP FI', 'Arturo Domínguez', 'Software', 'ALTA', 'EN_PROGRESO', SYSDATE, SYSDATE);

INSERT INTO tickets (ticket_id, titulo, descripcion, solicitante, categoria, prioridad, estado, fecha_creacion, fecha_actualizacion)
VALUES (22, 'SW007 - Licencia Adobe', 'La licencia Adobe venció', 'Natalia Ponce', 'Software', 'MEDIA', 'EN_PROGRESO', SYSDATE, SYSDATE);

INSERT INTO tickets (ticket_id, titulo, descripcion, solicitante, categoria, prioridad, estado, fecha_creacion, fecha_actualizacion)
VALUES (23, 'SW008 - VPN no conecta', 'Error de autenticación VPN', 'Héctor Medina', 'Software', 'ALTA', 'EN_PROGRESO', SYSDATE, SYSDATE);
...
-- Acceso EN_PROGRESO (2)
INSERT INTO tickets (ticket_id, titulo, descripcion, solicitante, categoria, prioridad, estado, fecha_creacion, fecha_actualizacion)
VALUES (29, 'AC004 - Alta usuario nuevo', 'Crear cuenta nuevo empleado', 'Teresa Molina', 'Acceso', 'ALTA', 'EN_PROGRESO', SYSDATE, SYSDATE);

INSERT INTO tickets (ticket_id, titulo, descripcion, solicitante, categoria, prioridad, estado, fecha_creacion, fecha_actualizacion)
VALUES (30, 'AC005 - Desbloqueo cuenta', 'Cuenta bloqueada por intentos', 'Oscar Fuentes', 'Acceso', 'ALTA', 'EN_PROGRESO', SYSDATE, SYSDATE);
...
-- Red EN_PROGRESO (1)
INSERT INTO tickets (ticket_id, titulo, descripcion, solicitante, categoria, prioridad, estado, fecha_creacion, fecha_actualizacion)
VALUES (34, 'RD003 - Punto red sin servicio', 'Punto de red escritorio 205', 'Ernesto Blanco', 'Red', 'ALTA', 'EN_PROGRESO', SYSDATE, SYSDATE);
...
--   EN_PROGRESO: 10 (4 HW + 3 SW + 2 AC + 1 RD)
